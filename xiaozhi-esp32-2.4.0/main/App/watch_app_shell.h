...
private:
    ...
    static void ScreenGestureCallback(lv_event_t* event);
    static void GlobalTouchCallback(lv_event_t* event);
    static void DisplayRenderCallback(lv_event_t* event);
    static void BrightnessDrawerTouchCallback(lv_event_t* event);
    ...
    void CreateSystemLayers(lv_obj_t* parent);
    void ShowBrightnessDrawer(bool visible);
    void ShowNotification(const char* text);
    void BringSystemLayersToFront();
    ...
    lv_obj_t* battery_area_ = nullptr;
    lv_obj_t* battery_bar_ = nullptr;
    lv_obj_t* battery_tip_ = nullptr;
    lv_obj_t* brightness_drawer_ = nullptr;
    lv_obj_t* brightness_slider_ = nullptr;
    lv_obj_t* notification_panel_ = nullptr;
    lv_obj_t* notification_label_ = nullptr;
    lv_timer_t* clock_timer_ = nullptr;
    int64_t notification_deadline_us_ = 0;
    bool brightness_drawer_visible_ = false;
    int32_t brightness_touch_last_y_ = 0;
    lv_point_t global_touch_start_ = {};
    bool global_touch_tracking_ = false;
    uint32_t rendered_frame_count_ = 0;
    uint32_t rendered_fps_ = 0;
    uint32_t last_menu_layout_tick_ = 0;
    int last_weather_code_ = -1000;
